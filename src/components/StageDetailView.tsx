...
export default function StageDetailView({ slug, onNavigate, lang, t, embedded = false }: StageDetailViewProps) {
  ...
  if (loading) {
    return (
      <div className="w-full min-h-screen pt-14 flex items-center justify-center bg-bg-dark">
  ...
  if (error || !stage) {
    return (
      <div className="w-full min-h-screen pt-14 flex flex-col items-center justify-center bg-bg-dark gap-4">
